...
/**
 ...
 var category: String //Category the item belongs to
 var location: String //Where the item is stored
 var currentQuantity: Double //How much of the item is currently being stored
 var neededQuantity: Double = 1 //How much of the item is needed, preset to 1
 var units: String //How the amount of the item is measured
 
 var note: String //Allows user to add notes regarding the item
